    ...
    <div className='footer'>
      <div className='footerin1'>
        <div className='f1'>
          ...
          <p>Help India  is a leading online Donation Platform  in India . We are committed to deliver the donated item directly to poor people.</p>
      ...
      <div className='footerin2'>
        <h3>© Copyright 2023 Help India , Inc.  All rights reserved</h3>
