        ...
        <nav>
            ...
            <div className='s2'>
                ...
                <Dropdown>
                    ...
                    <Dropdown.Menu>
                        <Dropdown.Item href="#/action-1">Medical Donation</Dropdown.Item>
                        <Dropdown.Item href="#/action-2">Food Donation</Dropdown.Item>
                        <Dropdown.Item href="#/action-3">Education Donation </Dropdown.Item>
                    </Dropdown.Menu>
                </Dropdown>
                <Link to='/about'>
                    <a>About Us</a>
                        ...
                        <ul className='s32'>
                            ...
                            <li><Dropdown>
                                ...
                                <Dropdown.Menu>
                                    <Dropdown.Item href="#/action-1">Medical Donation</Dropdown.Item>
                                    <Dropdown.Item href="#/action-2">Food Donation</Dropdown.Item>
                                    <Dropdown.Item href="#/action-3">Education donated</Dropdown.Item>
                                </Dropdown.Menu>
                            </Dropdown></li>
